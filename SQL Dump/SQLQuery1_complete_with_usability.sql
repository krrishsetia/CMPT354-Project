...
DROP TABLE IF EXISTS `sub-assembly-version`;
...
CREATE TABLE `sub-assembly-version` (
    VersionHistID INT AUTO_INCREMENT PRIMARY KEY,
    SATypeID      INT          NOT NULL,
    VersionNo     INT          NOT NULL,
    Description   VARCHAR(200) NOT NULL DEFAULT 'Auto-bumped by part change',
...
INSERT INTO `sub-assembly-version` (SATypeID, VersionNo, Description, ChangeDate) VALUES
(0, 1, 'Initial version', '2026-03-01 10:00:00'),
(1, 1, 'Initial version', '2026-03-01 10:00:00'),
(2, 1, 'Initial version', '2026-03-01 10:00:00'),
(3, 1, 'Initial version', '2026-03-01 10:00:00');
...
BEGIN
    ...
    FROM `Sub-Assembly` WHERE SATypeID = NEW.SATypeID;
    INSERT INTO `sub-assembly-version` (SATypeID, VersionNo, Description)
    VALUES (NEW.SATypeID, new_ver, CONCAT('Part ', NEW.PartID, ' added'));
END $$
...
BEGIN
    ...
    SELECT `Version` INTO new_ver
    FROM `Sub-Assembly` WHERE SATypeID = OLD.SATypeID;
    INSERT INTO `sub-assembly-version` (SATypeID, VersionNo, Description)
    VALUES (OLD.SATypeID, new_ver, CONCAT('Part ', OLD.PartID, ' removed'));
END $$
